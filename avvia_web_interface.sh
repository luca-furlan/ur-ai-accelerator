#!/bin/bash
# Script per avviare web interface con ROS2 configurato correttamente
...
if python3 -c "import rclpy; print('✅ rclpy disponibile')" 2>&1; then
    ...
    echo "⚠️ rclpy non disponibile - verificare installazione ROS2"
    echo "   Prova: sudo apt install ros-humble-desktop"
fi
