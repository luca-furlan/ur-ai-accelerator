#!/bin/bash
# Setup completo secondo guida pratica GitHub Gist
...
echo "Path completo: $(pwd)/$URCAP_FILE"
echo
...
echo
echo "6. Avvia il programma (PLAY sul Teach Pendant)"
echo
echo "================================================================================"
read -p "Premi INVIO quando hai configurato il programma e lo hai messo in PLAYING..."
echo
